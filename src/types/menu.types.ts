...
export interface CreateDrinkCategoryDto
  extends TablesInsert<"drink_categories"> {}
export interface UpdateDrinkCategoryDto
  extends TablesUpdate<"drink_categories"> {}

export interface CreateDrinkDto extends TablesInsert<"drinks"> {}
export interface UpdateDrinkDto extends TablesUpdate<"drinks"> {}

export interface CreateOptionCategoryDto
  extends TablesInsert<"option_categories"> {}
export interface UpdateOptionCategoryDto
  extends TablesUpdate<"option_categories"> {}
